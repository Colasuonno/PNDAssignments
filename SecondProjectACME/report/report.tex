...
Cipher and digest are left to the OpenVPN negotiation defaults
(AES-256-GCM as data cipher, SHA-256 as auth digest).
...
are left to the OPNsense defaults (AES-256-GCM with PRF SHA-256 and DH
group 14 for IKE; AES-256-GCM for the Child SAs).
